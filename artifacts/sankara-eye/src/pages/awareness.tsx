...
export default function Awareness() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#FCFBF9] font-sans select-none overflow-x-hidden text-slate-800 relative">
      ...
      {/* ── Top Nav ──────────────────────────────────────────────────────── */}
      {navVisible && (
        <header className="h-20 border-b border-orange-100/45 flex items-center justify-between px-6 md:px-12 bg-white/90 backdrop-blur-md fixed top-0 left-0 right-0 z-50 shadow-sm transition-all duration-300">
          <Link href="/">
            <a className="cursor-pointer hover:scale-[1.02] transition-transform flex items-center">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/donate?intent=pledge">
              <Button className="bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white rounded-xl text-xs font-black px-5 py-2.5 shadow-md shadow-orange-500/20 transition-all cursor-pointer hover:scale-[1.02] border-0">
                Pledge Eyes Now
              </Button>
            </Link>
          </div>
