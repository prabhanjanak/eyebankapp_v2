...
export default function Donate() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#FAFAFA] flex flex-col select-none relative overflow-x-hidden">
      ...
      {/* Premium Header */}
      <header className="h-16 md:h-20 bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-3 sm:px-6 md:px-12 sticky top-0 z-50">
        <a href="https://sankaraeye.com/" target="_blank" rel="noopener noreferrer" className="shrink-0">
          <img src={`${BASE_PATH}/logo.png`} alt="Sankara Eye Foundation" className="h-8 sm:h-10 md:h-12 object-contain cursor-pointer hover:scale-[1.01] transition-transform duration-300" />
        </a>
        <div className="flex items-center gap-1.5 sm:gap-3 shrink-0">
          ...
          <Link href="/">
            <Button variant="ghost" size="sm" className="text-gray-500 hover:text-gray-900 rounded-xl h-8 sm:h-9 md:h-10 text-xs font-semibold gap-1 sm:gap-1.5 cursor-pointer px-2 sm:px-3">
